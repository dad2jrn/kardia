...
const pastoralItems: FaqItem[] = [
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">James 4:1–2 &nbsp;·&nbsp; Jeremiah 17:9 — "The heart is deceitful above all things" &nbsp;·&nbsp; Mark 7:21–23 — Jesus locates the source of all evil within the human heart</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Exodus 20:5–6 — generational patterns, not supernatural curses &nbsp;·&nbsp; Ephesians 6:10–18 &nbsp;·&nbsp; Romans 12:2 — "be transformed by the renewing of your mind"</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Mark 9:17–27 &nbsp;·&nbsp; Acts 10:38 — "healing all who were oppressed" &nbsp;·&nbsp; James 5:16 — the healing power of honest confession in community</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Acts 17:11 — the Berean commendation &nbsp;·&nbsp; 1 Thessalonians 5:21 &nbsp;·&nbsp; The Nicene Creed — examine what is and is not required</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Luke 4:18 — "to proclaim freedom for the prisoners" &nbsp;·&nbsp; Matthew 11:4–5 — Jesus's own summary of His ministry &nbsp;·&nbsp; Acts 10:38</p>
      </>
    ),
  },
]
...
const clarityItems: FaqItem[] = [
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Matthew 16:22–23 — Peter as "satan" &nbsp;·&nbsp; Job 1–2 — the accuser as a role &nbsp;·&nbsp; Zechariah 3:1–2 — the accuser in the heavenly court</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Matthew 4:1–11 &nbsp;·&nbsp; Hebrews 5:8–9 &nbsp;·&nbsp; Romans 5:19 — "through the obedience of the one man"</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Revelation 12:9 &nbsp;·&nbsp; Revelation 20:2 &nbsp;·&nbsp; Isaiah 27:1 — Leviathan as chaos symbol &nbsp;·&nbsp; Job 26:13</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">2 Corinthians 10:3–5 &nbsp;·&nbsp; Romans 12:2 &nbsp;·&nbsp; Philippians 4:8 — the discipline of directed thought</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">1 Enoch 6–11 — the Watcher tradition &nbsp;·&nbsp; Zechariah 3:1–2 — the pre-exilic accuser role &nbsp;·&nbsp; Daniel 10 — Persian-period angelology development</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">James 4:7–8 &nbsp;·&nbsp; Romans 8:11 &nbsp;·&nbsp; Galatians 5:16–17 — "the flesh desires what is contrary to the Spirit"</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Romans 14:1–4 — receiving those whose faith is different &nbsp;·&nbsp; Ephesians 4:3 — "make every effort to keep the unity of the Spirit" &nbsp;·&nbsp; 1 Corinthians 8 — knowledge and love</p>
      </>
    ),
  },
]
...
const objectionItems: FaqItem[] = [
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Job 1:6 — "the sons of God came to present themselves, and the satan also came" &nbsp;·&nbsp; Zechariah 3:1–2 — the same prosecutorial role &nbsp;·&nbsp; Numbers 22:22 — the angel of the Lord acting as "satan" (adversary) to Balaam</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Jude 9 &nbsp;·&nbsp; Jude 14–15 — Enoch also quoted as illustration &nbsp;·&nbsp; 2 Peter 2:11 — parallel passage without the name "devil"</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Luke 10:17–20 &nbsp;·&nbsp; Isaiah 14:12–15 — the same imagery for Babylon's king &nbsp;·&nbsp; John 12:31 &nbsp;·&nbsp; Revelation 12:10 — "the accuser of our brothers has been hurled down"</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">1 Peter 5:6–10 &nbsp;·&nbsp; Psalm 22:13, 21 &nbsp;·&nbsp; James 4:7 — the same "resist" language</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Ephesians 6:10–18 &nbsp;·&nbsp; Colossians 2:15 — Christ disarming "the powers and authorities" at the cross &nbsp;·&nbsp; Romans 8:38–39 — principalities and powers cannot separate from God's love</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">John 8:37–47 &nbsp;·&nbsp; Genesis 3 — "the beginning" &nbsp;·&nbsp; Mark 7:21–23 — Jesus on the interior source of evil &nbsp;·&nbsp; 1 John 3:8 — "the devil has been sinning from the beginning"</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Irenaeus, Against Heresies 3.18–19 — recapitulation Christology &nbsp;·&nbsp; Galatians 1:8 — even an apostle is not the final authority &nbsp;·&nbsp; Acts 17:11</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">Genesis 3:22–24 &nbsp;·&nbsp; Romans 5:12 — "sin entered the world through one man" &nbsp;·&nbsp; James 1:13 — "God cannot be tempted by evil, nor does he tempt anyone"</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">2 Timothy 3:16–17 — the sufficiency of canonical Scripture &nbsp;·&nbsp; Matthew 5:17 — Jesus and the Law &nbsp;·&nbsp; Luke 24:27 — the whole Old Testament points to Christ, not to angelology</p>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="faq-scripture">2 Corinthians 10:3–5 &nbsp;·&nbsp; Romans 12:2 &nbsp;·&nbsp; Philippians 4:8 &nbsp;·&nbsp; C.S. Lewis, The Screwtape Letters, Preface — Lewis's own qualification of the work</p>
      </>
    ),
  },
]
      ...
      {items.map((item, i) => {
        ...
        return (
          <div key={i} className="faq-item">
            <div className={`faq-q${isOpen ? ' open' : ''}`} onClick={() => toggle(i)}>
